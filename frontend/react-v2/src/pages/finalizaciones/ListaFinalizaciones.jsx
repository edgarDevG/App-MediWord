/* ══════════════════════════════════════════════════════════════
   ListaFinalizaciones.jsx — MediWork HSM v2
   Listado de médicos con estado FINALIZADO (contratos finalizados)
   ══════════════════════════════════════════════════════════════ */
...
export default function ListaFinalizaciones({ showToast }) {
  ...
  const fetchData = useCallback(() => {
    setLoading(true);
    const params = new URLSearchParams({ page, size: SIZE, estado: 'FINALIZADO' });
    ...
    axiosInstance.get(`/medicos/?${params}`, { skipToast: true })
      ...
      .catch(() => showToast?.('Error cargando finalizaciones', 'error'))
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '0.8125rem', color: '#64748b', marginTop: 3 }}>
            Contratos finalizados · Registros de solo lectura
          </p>
        </div>
        <div style={{
          ...
          <span className="material-symbols-outlined" style={{ fontSize: 18, color: '#7c3aed' }}>
            event_busy
          </span>
          <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: '#5b21b6' }}>
                  ...
                  <tr>
                    <td colSpan={6} style={{ textAlign: 'center', padding: '3.5rem', color: '#94a3b8' }}>
                      ...
                      <p style={{ fontWeight: 700, color: '#64748b', fontSize: '0.9375rem' }}>
                        No se encontraron finalizaciones
                      </p>
                      {search && (
                    ...
                    >
                      ...
                      <td style={{ padding: '11px 16px' }}>
                        <span style={{
                          ...
                          background: 'rgba(124,58,237,0.08)', padding: '3px 10px', borderRadius: 9999,
                        }}>
