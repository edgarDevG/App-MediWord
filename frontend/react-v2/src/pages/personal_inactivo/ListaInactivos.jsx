/* ══════════════════════════════════════════════════════════════
   ListaInactivos.jsx — MediWork HSM v2
   Listado de médicos con estado INACTIVO
   ══════════════════════════════════════════════════════════════ */
...
export default function ListaInactivos({ showToast }) {
  ...
  const fetchData = useCallback(() => {
    setLoading(true);
    const params = new URLSearchParams({ page, size: SIZE, estado: 'INACTIVO' });
    ...
    axiosInstance.get(`/medicos/?${params}`, { skipToast: true })
      ...
      .catch(() => showToast?.('Error cargando personal inactivo', 'error'))
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '0.8125rem', color: '#64748b', marginTop: 3 }}>
            Médicos inactivos · Posibilidad de reactivación (rol admin)
          </p>
        </div>
        <div style={{
                  ...
                  <tr>
                    <td colSpan={6} style={{ textAlign: 'center', padding: '3.5rem', color: '#94a3b8' }}>
                      ...
                      <p style={{ fontWeight: 700, color: '#64748b', fontSize: '0.9375rem' }}>
                        No se encontró personal inactivo
                      </p>
                      {search && (
                    ...
                    >
                      ...
                      <td style={{ padding: '11px 16px' }}>
                        <span style={{
                          ...
                          background: 'rgba(100,116,139,0.08)', padding: '3px 10px', borderRadius: 9999,
                        }}>
